...
2. Add/update feature files in `src/test/resources/features/`
...
**Note**: This framework targets the shared QA environment at `https://nop-qa.portnov.com`. Data changes frequently, so tests are designed to be idempotent with unique data generation.
